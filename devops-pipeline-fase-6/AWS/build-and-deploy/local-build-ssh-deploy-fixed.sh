...
# =============================================================================
# LOCAL BUILD + SSH DEPLOY SCRIPT - FIXED VERSION
# =============================================================================
...
# Fix: dalla directory build-and-deploy (AWS/build-and-deploy) risaliamo alla root
...
if [ ! -d "$PROJECT_ROOT/backend" ]; then
    ...
    echo -e "${YELLOW}[INFO]${NC} Struttura directory attuale:"
    ls -la "$PROJECT_ROOT/"
    exit 1
fi
