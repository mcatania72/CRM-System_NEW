...
# =============================================================================
# LOCAL BUILD + SSH DEPLOY SCRIPT - DOCKER SIMPLIFIED VERSION
# =============================================================================
...
if [ ! -d "$PROJECT_ROOT/backend" ] || [ ! -d "$PROJECT_ROOT/frontend" ]; then
    log_error "Backend o Frontend directory non trovate"
    exit 1
fi
...
build_backend() {
    ...
    if [ ! -f "dist/app.js" ]; then
        log_error "Build backend fallito!"
        exit 1
    fi
...
create_deployment_package() {
    ...
    # Crea nginx.conf SEMPRE presente
...
EOF
    ...
    # Crea docker-compose SEMPLIFICATO
...
EOF
    ...
    # Crea archivio in modo sicuro
    log_info "Creando archivio deployment..."
    tar -czf /tmp/crm-deployment.tar.gz -C "$BUILD_DIR" .
    mv /tmp/crm-deployment.tar.gz "$BUILD_DIR/"
