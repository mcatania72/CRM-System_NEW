...
# =============================================================================
# FASE 1: Build su DEV_VM (24GB RAM)
# FASE 2: SSH Deploy su AWS EC2 t2.micro
# FASE 3: Test e monitoring su AWS
# =============================================================================
...
create_deployment_package() {
    ...
    cp "$PROJECT_ROOT/devops-pipeline-fase-6/AWS"/*.yml . 2>/dev/null || true
    cp "$PROJECT_ROOT/devops-pipeline-fase-6/AWS"/*.yaml . 2>/dev/null || true
